...
const TRIAD_SETS: TriadSet[] = [
  ...
  { id: "charcot-ms", title: "Charcot's neurologic triad", topic: "Multiple sclerosis", clues: ["A client is being assessed for multiple sclerosis.", "Select the three classic neurologic findings from the source."], terms: ["Scanning speech", "Intention tremor", "Nystagmus"], decoys: ["Ataxia", "Jaundice", "Pinpoint pupils"], explanation: "Charcot's neurologic triad in multiple sclerosis consists of scanning speech, intention tremor, and nystagmus." },
  { id: "cushing", title: "Cushing's triad", topic: "Increased intracranial pressure", clues: ["A neurologic client is deteriorating with markedly increased intracranial pressure.", "Identify the late vital-sign pattern in the supplied material."], terms: ["Hypertension", "Bradycardia", "Bradypnea"], decoys: ["Tachycardia", "Hypotension", "Kussmaul respirations"], explanation: "Your source lists hypertension, bradycardia, and bradypnea as Cushing's triad of increased intracranial pressure." },
  { id: "dieulafoy", title: "Dieulafoy's triad", topic: "Acute appendicitis", clues: ["A client has suspected acute appendicitis with localized right lower-quadrant findings.", "Choose the three findings named in the source."], terms: ["Skin hyperesthesia", "Exquisite tenderness", "Guarding over McBurney's point"], decoys: ["Flank pain", "Conjunctivitis", "Pulsatile abdominal mass"], explanation: "The supplied study material identifies skin hyperesthesia, exquisite tenderness, and guarding over McBurney's point." },
  { id: "graves", title: "Graves' disease triad", topic: "Endocrine", clues: ["A client is being assessed for classic findings of Graves' disease.", "Select the three manifestations in the source."], terms: ["Goiter", "Exophthalmos", "Pretibial myxedema"], decoys: ["Edema", "Nystagmus", "Jaundice"], explanation: "The triad for Graves' disease is goiter, exophthalmos, and pretibial myxedema." },
  { id: "opioid", title: "Opioid overdose triad", topic: "Toxicology", clues: ["A client has a suspected opioid overdose.", "Identify the central nervous system and respiratory findings that occur together."], terms: ["Respiratory depression", "Pinpoint pupils", "CNS depression"], decoys: ["Hypertension", "Conjunctivitis", "Intention tremor"], explanation: "The source groups respiratory depression, pinpoint pupils, and CNS depression as the opioid overdose triad." },
  { id: "hutchinson", title: "Hutchinson's triad", topic: "Congenital syphilis", clues: ["A child is being assessed for congenital syphilis.", "Select the three classic findings."], terms: ["Hutchinson's teeth", "Interstitial keratitis", "Sensorineural deafness"], decoys: ["Exophthalmos", "Coryza", "Ataxia"], explanation: "Hutchinson's triad is Hutchinson's teeth, interstitial keratitis, and sensorineural deafness." },
  { id: "measles", title: "Three Cs of measles", topic: "Communicable disease", clues: ["A child has a suspected measles infection.", "Recall the three C symptoms from the source."], terms: ["Cough", "Coryza", "Conjunctivitis"], decoys: ["Clubbing", "Cyanosis", "Constipation"], explanation: "The Three Cs of measles are cough, coryza, and conjunctivitis." },
  { id: "kwashiorkor", title: "Kwashiorkor triad", topic: "Nutrition", clues: ["A child has severe protein malnutrition.", "Select the three manifestations listed for kwashiorkor."], terms: ["Growth retardation", "Mental changes", "Edema"], decoys: ["Goiter", "Flank pain", "Bradypnea"], explanation: "The supplied material lists growth retardation, mental changes, and edema for kwashiorkor." },
  { id: "renal-carcinoma", title: "Renal carcinoma triad", topic: "Genitourinary", clues: ["A client is being assessed for possible renal carcinoma.", "Choose the three classic manifestations from the source."], terms: ["Hematuria", "Palpable abdominal mass", "Flank pain"], decoys: ["Chest pain", "Coryza", "Muffled heart sounds"], explanation: "The renal carcinoma triad is hematuria, a palpable abdominal mass, and flank pain." },
  { id: "virchow", title: "Virchow's triad", topic: "Venous thrombosis", clues: ["A client is immobile after major surgery.", "Think of the three conditions that make venous thrombus formation more likely."], terms: ["Stasis", "Hypercoagulability", "Vessel injury"], decoys: ["Bradycardia", "Hypovolemia", "Muffled heart sounds"], explanation: "Virchow's triad explains thrombosis through stasis, hypercoagulability, and vessel injury." },
  { id: "wernicke", title: "Wernicke's encephalopathy triad", topic: "Neurologic", clues: ["A client with severe malnutrition or alcohol use has acute neurologic changes.", "Select the three findings listed in the source."], terms: ["Confusion", "Ophthalmoplegia", "Ataxia"], decoys: ["Nystagmus", "Hyperthermia", "Edema"], explanation: "The source lists confusion, ophthalmoplegia, and ataxia for Wernicke's encephalopathy." },
  { id: "whipple", title: "Whipple's triad", topic: "Insulinoma and hypoglycemia", clues: ["A client has symptoms suggestive of hypoglycemia from an insulinoma.", "Choose the three components used to establish Whipple's triad."], terms: ["Symptoms during hypoglycemia", "Low blood glucose", "Symptoms resolve when glucose is corrected"], decoys: ["Hypertension", "Hearing loss", "Flank pain"], explanation: "Whipple's triad connects symptoms caused by low glucose with documented low blood glucose and relief after glucose correction." },
  { id: "aortic-stenosis", title: "Aortic stenosis triad", topic: "Cardiovascular", clues: ["A client has progressive aortic valve narrowing.", "Select the three manifestations from the supplied material."], terms: ["Chest pain", "Heart failure", "Syncope"], decoys: ["Hematuria", "Guarding", "Pinpoint pupils"], explanation: "The source identifies chest pain, heart failure, and syncope as the aortic stenosis triad." },
  { id: "murphy", title: "Murphy's triad", topic: "Acute appendicitis", clues: ["A client has acute appendicitis symptoms.", "Choose the three components of Murphy's triad as listed in the source."], terms: ["Pain", "Vomiting", "Fever"], decoys: ["Cough", "Edema", "Bradycardia"], explanation: "Murphy's triad for acute appendicitis is pain, vomiting, and fever." },
  { id: "macdonald", title: "MacDonald triad", topic: "Behavioral health", clues: ["Recall the behavioral warning signs grouped in the MacDonald triad.", "Select all three behaviors."], terms: ["Enuresis", "Fire-setting", "Animal cruelty"], decoys: ["Syncope", "Coryza", "Ataxia"], explanation: "The source lists enuresis, fire-setting, and animal cruelty as the MacDonald triad." },
];
